                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="false" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="email"><center>Status Dokumen</center></th>
                                                <th data-field="action"><center>Action</center></th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                        <?php $i=1; foreach($data_verifikasistudent as $row){ ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <span class="btn btn-outline-success">Lolosdol</span>
                                                    <?php }else if($row['is_verify'] == 2){ ?>
                                                        <span class="btn btn-outline-danger">Tidak Lolos</span>
                                                    <?php } ?>
                                                </td>
                                                <td>
                                                <center>
                                                    ...
                                                    <span data-toggle="tooltip" data-toggle="tooltip" data-placement="top" title="Hapus Data">
                                                        <button onClick="" data-toggle="modal" data-target="#modal_delete" type="button" class="btn btn-warning btn-circle btn-icon">
                                                            <i class="fa fa-user"></i></button>
                                                    </span>
                                                    <span data-toggle="tooltip" data-toggle="tooltip" data-placement="top" title="Edit Data">
                                                        <button onClick="" data-toggle="modal" data-target="#modaltambah" type="button" class="btn btn-success btn-circle btn-icon">
